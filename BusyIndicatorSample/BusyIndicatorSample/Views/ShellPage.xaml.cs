...
namespace BusyIndicatorSample.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<BacisPage>("Shell_Bacis".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Sample1Page>("Shell_Sample1".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Sample2Page>("Shell_Sample2".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<Sample3Page>("Shell_Sample3".GetLocalized(), Symbol.Document));
